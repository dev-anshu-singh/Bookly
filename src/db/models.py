...
class Book(SQLModel, table=True):
    ...
    tags: List["Tag"] = Relationship(link_model=BookTag,
...
class User(SQLModel, table=True):
    ...
    first_name:str
    last_name:str
    # when add new field to a db which already has data provide default data for it to fill
    ...
    # do not be part of serialization (turning the model to JSON while returning etc.)
    created_at: datetime = Field(sa_column=Column(pg.TIMESTAMP, default=datetime.now))
